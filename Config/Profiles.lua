      ...
      if oldVersion < 2 then
        for id, profile in pairs(profiles.list) do
          ...
          if
            ...
            -- Quest Items
            and (type(profile.structure.primary.layout[5][1]) == "table" and profile.structure.primary.layout[5][1].name == string.format(
              L.Suffix_Items,
              L.Quest
            ) and type(profile.structure.primary.layout[5][1].categories) == "table" and table.getn(
              profile.structure.primary.layout[5][1].categories
            ) == 2 and BsUtil.TableContainsValue(profile.structure.primary.layout[5][1].categories, "Quest") and BsUtil.TableContainsValue(
              profile.structure.primary.layout[5][1].categories,
              "ActiveQuest"
            ))
            -- Keys
            and (type(profile.structure.primary.layout[5][2]) == "table" and profile.structure.primary.layout[5][2].name == L.Keys and type(
              profile.structure.primary.layout[5][2].categories
            ) == "table" and table.getn(profile.structure.primary.layout[5][2].categories) == 1 and profile.structure.primary.layout[5][2].categories[1] == "KeyAndKeyLike")
          ...
          then
            ...
            table.insert(profile.structure.primary.layout[2][1].categories, "Tokens")
      ...
      if oldVersion < 3 then
        for id, profile in pairs(profiles.list) do
          ...
          if
            ...
            -- Mounts/Companions
            and (type(profile.structure.primary.layout[1][3]) == "table" and profile.structure.primary.layout[1][3].name == string.format(
              "%s/%s",
              L.Mounts,
              L.Companions
            ) and type(profile.structure.primary.layout[1][3].categories) == "table" and table.getn(
              profile.structure.primary.layout[1][3].categories
            ) == 2 and BsUtil.TableContainsValue(
              profile.structure.primary.layout[1][3].categories,
              "Mounts"
            ) and BsUtil.TableContainsValue(profile.structure.primary.layout[1][3].categories, "Companions"))
            -- Junk
            and (type(profile.structure.primary.layout[1][4]) == "table" and profile.structure.primary.layout[1][4].name == L.Junk and type(
              profile.structure.primary.layout[1][4].categories
            ) == "table" and table.getn(profile.structure.primary.layout[1][4].categories) == 1 and profile.structure.primary.layout[1][4].categories[1] == "QualGray")
            -- Safeguard to make sure profile default exists.
            and Bagshui.config.Profiles
            and Bagshui.config.Profiles.defaults
            and Bagshui.config.Profiles.defaults[1]
          ...
          then
            ...
            table.insert(profile.structure.primary.layout[2][1].categories, "Openable")
            table.sort(profile.structure.primary.layout[2][1].categories)
          end
        end
      end
