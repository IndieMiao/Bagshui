...
Bagshui:LoadComponent(function()
    ...
    if frame then
      frame:AddMessage(
        string.format(
          ...
          (
            noPrefix and ""
            or string.format("[Bagshui%s] ", (component and string.format(" %s", tostring(component)) or ""))
          ),
          tostring(msg)
        ),
  ...
  function Bagshui:PrintError(msg, component)
    ...
    self:Print(msg, component, BS_COLOR.PRINT_ERROR[1], BS_COLOR.PRINT_ERROR[2], BS_COLOR.PRINT_ERROR[3])
  end
  ...
  function Bagshui:PrintWarning(msg, component)
    ...
    self:Print(msg, component, BS_COLOR.PRINT_WARNING[1], BS_COLOR.PRINT_WARNING[2], BS_COLOR.PRINT_WARNING[3])
  end
  ...
  function Bagshui:ShowErrorMessage(msg, component, r, g, b, a, duration, log, noPrefix)
    ...
    self:Print(msg, component, r or 1, g or 0, b or 0, a or 1, _G.UIErrorsFrame, duration or 3, noPrefix)
  end
  ...
  function Bagshui:ShowAndLogErrorMessage(msg, component, r, g, b, a, duration)
    self:ShowErrorMessage(msg, component, r, g, b, a, duration, true)
  end
