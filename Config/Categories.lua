  ...
  Bagshui.config.Categories = {
    ...
    defaults = {
...

      {
        ...
        rule = string.format(
          'Tooltip("%s") and Tooltip("%s", "%s")',
          L.TooltipIdentifier_Food,
          L.TooltipIdentifier_Buff_WellFed,
          L.TooltipIdentifier_Buff_AlsoIncreases
        ),
      },
...

      {
        ...
        rule = string.format('Name("%s", "%s")', L.NameIdentifier_Elixir, L.NameIdentifier_Concoction_TurtleWoW),
      ...
      -- Normally type: Consumable, subtype: Consumable
      {
        ...
        name = L.FirstAid,
        rule = string.format(
          '(Subtype("%s") and Name("%s", "%s")) or PeriodicTable("Consumable.Bandage", "Misc.Antivenom")',
          L.Consumables,
          L.NameIdentifier_Bandage,
          L.NameIdentifier_AntiVenom
        ),
      },
      ...
      -- This relies on the Character table that's provided in the rule environment.
      {
        ...
        rule = string.format(
          'Type("%s") and Subtype("%s") and RequiresClass(character.localizedClass)',
          L.Recipe,
          L.Book
        ),
      },
